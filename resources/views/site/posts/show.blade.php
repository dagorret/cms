...
@section('content')
<article class="border border-[#d8d0c3] bg-[#fffaf2] p-[clamp(24px,4vw,54px)] dark:border-[#4a4640] dark:bg-[#211f1c]">
...
<div class="text-[1.12rem] leading-[1.68] text-[#171717] dark:text-[#ded7cc] [&_blockquote]:my-7 [&_blockquote]:border-l-[5px] [&_blockquote]:border-[#8a6f2a] [&_blockquote]:bg-[#f5eddb] dark:[&_blockquote]:bg-[#302b22] [&_blockquote]:px-5 [&_blockquote]:py-4 [&_blockquote]:italic [&_h2]:mt-[2.1em] [&_h2]:text-[1.55rem] [&_h2]:font-bold [&_h2]:leading-[1.15] [&_h2]:tracking-[-.02em] [&_p]:my-[1.25em] [&_pre]:overflow-x-auto [&_pre]:bg-[#24211d] [&_pre]:p-[18px] [&_pre]:text-[#f7f3eb]">
